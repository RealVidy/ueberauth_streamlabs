defmodule Ueberauth.Strategy.Streamlabs.OAuth do
  @moduledoc """
  OAuth2 for Streamlabs.
  ...
  @defaults [
    strategy: __MODULE__,
    site: "https://streamlabs.com/api/v1.0",
    authorize_url: "/authorize",
    token_url: "https://streamlabs.com/api/v1.0/token"
  ]

  @doc """
  Construct a client for requests to Streamlabs.

  This will be setup automatically for you in `Ueberauth.Strategy.Streamlabs`.
